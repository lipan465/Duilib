...
namespace DuiLib
{
	...
	bool CTreeViewUI::Add( CTreeNodeUI* pControl )
	{
		...
		pControl->OnNotify += MakeDelegate(&CTreeViewUI::OnDBClickItem,this);
		pControl->GetFolderButton()->OnNotify += MakeDelegate(&CTreeViewUI::OnFolderChanged,this);
		pControl->GetCheckBox()->OnNotify += MakeDelegate(&CTreeViewUI::OnCheckBoxChanged,this);
