...
namespace DuiLib {
	...
	void CPaintManagerUI::Init(HWND hWnd, LPCTSTR pstrName)
	{
		...
		//SetTargetWnd(hWnd);
		//InitDragDrop();
		m_pDropTarget = new CIDropTarget();
		m_pDropTarget->DragDropRegister(this,hWnd);
	}
	...
	void CPaintManagerUI::RemoveAllShareResource()
	{
		//remove shared DefaultAttr
